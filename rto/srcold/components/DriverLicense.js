...
const DriverLicense = () => {
  ...
  return (
    <div className="driver-license-container">
      ...
      Our user-friendly application process is designed to guide you through each step, 
      from providing your personal details to submitting the required documents.
       Whether you're a first-time applicant or renewing your license, we ensure a seamless experience to help you get on the road quickly and safely.
      ...
      <p class="instructions">
          ...
          Following are the stages in Application Submission in Issuing Driving Licence in the following order<br></br>
          1.  Fill Applicant Details<br></br>
          2. Upload Documents<br></br>
          3. Upload Photo and Signature if required (applicable for only some states)<br></br>
          4. DL Test Slot Booking (applicable for only some states)<br></br>
